        ...
        <div className="flex gap-6">
          ...
          <main className="flex-1 bg-white rounded-lg shadow-sm p-6 min-h-[70vh]">
            <header className="mb-6">
              <h1 className="text-2xl font-semibold">Chào mừng đến với DocuChat</h1>
              <p className="text-sm text-slate-600 mt-2">
                Bắt đầu chat với tài liệu của bạn ngay hôm nay. Tải lên tài liệu hoặc tạo cuộc trò chuyện mới.
              </p>
            </header>
            ...
            <section className="h-full flex items-center justify-center">
              <div className="text-center text-slate-500">
                ...
                <button className="px-4 py-2 bg-indigo-600 text-white rounded-md">Bắt đầu cuộc trò chuyện mới</button>
              </div>
            </section>
          </main>

          {/* Right chatbox placeholder */}
          <aside className="w-[420px] bg-white rounded-lg shadow-sm p-4">
            <div className="h-[70vh] border-2 border-dashed border-slate-200 rounded-md flex items-center justify-center">
              <p className="text-slate-400">Chatbox component sẽ được hoàn thiện ở đây</p>
            </div>
          </aside>
        </div>
      </div>
