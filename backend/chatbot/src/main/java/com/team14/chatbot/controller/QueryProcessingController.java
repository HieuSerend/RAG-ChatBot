...
public class QueryProcessingController {
         ...
         *
         * @param request The query processing request containing the raw query and
         *                options
         * @return QueryProcessingResponse with routing decision, transformed queries,
        ...
        /**
         * Quick route check - only performs intent classification without full
         * processing.
