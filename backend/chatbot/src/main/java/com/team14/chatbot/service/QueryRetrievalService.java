...
import com.team14.chatbot.dto.response.CragEvaluation;
import com.team14.chatbot.dto.response.RetrievalResponse;
...
public class QueryRetrievalService {
    ...
    public RetrievalResponse retrieveDocuments(String query, Map<String, Object> filterMetadata) {
        return retrieveDocuments(query, filterMetadata, enableCrag, 0);
    }
